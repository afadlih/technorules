...
<aside class="fixed left-0 top-0 h-screen w-[5em] border-r border-gray-200 bg-[#0242a6] shadow-md transition-all duration-300 ease-in-out lg:w-[17rem] flex flex-col">
    ...
    <?php
        $sidebar_items = [
            ["gambar" => "/technorules/images/home.svg", "label" => "Dashboard", "url" => "/technorules/mahasiswa"],
            ["gambar" => "/technorules/images/message.svg", "label" => "Message", "url" => "/technorules/mahasiswa/message"],
        ];
